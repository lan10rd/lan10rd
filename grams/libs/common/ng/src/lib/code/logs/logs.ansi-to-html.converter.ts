...
function resetStyles(stack: any) {
    ...
    return stackClone.reverse().map(function (tag: any) {
        return '</' + tag + '>';
    }).join('');
}
 ...
 */
function range(low: any, high: any) {
    const results = [];
 ...
 * @returns {function}
 */
function notCategory(category: any) {
 ...
 * @returns {string}
 */
function pushTag(stack: any, tag: any, style?: any) {
    if (!style) {
        style = '';
    }
 ...
 * @returns {string}
 */
function pushStyle(stack: any, style: any) {
    return pushTag(stack, 'span', style);
}

function pushForegroundColor(stack: any, color: any) {
    return pushTag(stack, 'span', 'color:' + color);
}

function pushBackgroundColor(stack: any, color: any) {
 ...
 * @returns {string}
 */
function closeTag(stack: any, style: any) {
    let last;
 ...
 * @returns {Array}
 */
function tokenize(text: any, options: any, callback: any) {
    let ansiMatch = false;
    const ansiHandler = 3;
...
export class Convert {
    ...
    toHtml(input: any) {
        ...
        this.stickyStack.forEach((element: any) => {
